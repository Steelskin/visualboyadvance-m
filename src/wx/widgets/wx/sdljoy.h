...
protected:
    ...
    void CreateAndSendEvent(wxEvtHandler* handler, int player_index, unsigned short ctrl_type, unsigned short ctrl_idx, short ctrl_val, short prev_val);
